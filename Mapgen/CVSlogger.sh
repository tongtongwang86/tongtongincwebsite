...
while true; do
    ...
    if [ $serialnumber,$locationtimestamp = ${lastLocationTimestamp[$j]} ]
    then
    echo "da same :("
    ...
    echo $serialnumber,$locationtimestamp
    echo ${lastLocationTimestamp[$j]}
    
    lastLocationTimestamp[$j]="$serialnumber,$locationtimestamp"
    
#    for value in "${lastLocationTimestamp[@]}"
#    do
#         echo $value
#
#    done
	...
	echo -e "Checking again in 5 sec...\n"
	sleep 5
