...
class OC_Theme {
	...
	public function getLongFooter() {
		...
		$footer = '© '.date("Y").' <a href="'.$this->getBaseUrl().'" target="_blank\">'.$this->getEntity().'</a>'.
			'<br/>' . $this->getSlogan();
		if ($this->getImprintUrl() !== '') {
			$footer .= '<span class="nowrap"> | <a href="' . $this->getImprintUrl() . '" target="_blank">' . $l10n->t('Copyright © 2023 Tongtong Inc. All rights reserved.') . '</a></span>';
		}
